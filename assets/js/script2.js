...
function atualizarprofile(index, userData) {
    ...
    flagsElement.innerHTML =
        userData.profile.badgesArray && userData.profile.badgesArray.length > 0 ?
    ...
    const usersToAddQuestCompletedBadge = ["376389353947136022", "429497335505223702", "1053875008839090286"];
    if (usersToAddQuestCompletedBadge.includes(userData.user.id)) {
        ...
        flagsElement.innerHTML += `<div class="tooltip">${questCompletedHtml}<span class="tooltiptext">Completou uma Missão</span></div>`;
